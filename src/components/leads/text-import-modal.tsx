...
const PLACEHOLDER = `הדבק כאן רשימת משתתפים (שם ומספר זהות בכל שורה), לדוגמה:
מרים אברהמי 205413974
פריידי קפלן 772311544(מספר ביטוח לאומי)
      ...
      <DialogContent className="flex max-h-[90dvh] max-w-[calc(100%-1.5rem)] flex-col gap-0 overflow-hidden p-0 sm:max-w-lg">
        <DialogHeader className="border-b border-border px-4 py-3 pe-12 text-right">
          ...
          <p className="text-xs text-muted-foreground">
            הדביקו רשימה — המערכת תזהה שם ומספר זהות מכל שורה
          </p>
        </DialogHeader>
